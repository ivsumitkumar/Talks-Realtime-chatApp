	...
	<div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
		<div class="main-left col-span-1">
			<div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
				...
				<div class="mt-6 flex space-x-8 justify-around">
					...
					<p class="text-xs text-gray-500">127 Posts</p>
				</div>
			</div>
		</div>
		<div class="main-center col-span-2 space-y-4">
			<div class="bg-white border border-gray-200 rounded-lg">
				<div class="p-4">
					<textarea class="p-4 w-full bg-gray-100 rounded-lg"
						placeholder="What are you talking about Today ?"></textarea>
				</div>
			...
			<div class="p-4 bg-white border border-gray-200 rounded-lg">
				...
				<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis odit, expedita, at eum dolor
					obcaecati architecto enim animi culpa ratione, accusamus fugit consequuntur vel nisi nesciunt officiis
					blanditiis dicta ullam quisquam? Asperiores deleniti, excepturi ea voluptas quidem sit blanditiis quasi
					inventore ipsa beatae vero architecto perferendis at odit doloribus assumenda?</p>
			...
			<div class="p-4 bg-white border border-gray-200 rounded-lg">
				...
				<div class="space-y-4">
					<div class="flex items-center justify-between">
						<div class="flex items-center space-x-2">
							<img src="https://i.pravatar.cc/300?img=70" class="w-[40px] rounded-full">
							<p class="text-xs"><strong>Test User</strong></p>
						</div>
